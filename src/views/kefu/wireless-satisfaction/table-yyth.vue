...
<template>
  ...
  >
    ...
    <el-table-column prop="jqmyd" label="语音通话感知" width="40">
      <template slot-scope="scope">
    ...
    <el-table-column label="语音通话感知关键过程表现">
      <el-table-column prop="answer_B3" label="网络覆盖与信号强度" width="65">
        <template slot-scope="scope">
          <div :style="{backgroundColor: color(scope.row.sn_answer_B3),fontWeight: scope.row.city_name === '全省'?'bold':'normal'}">{{ scope.row.answer_B3 }}</div>
        </template>
      </el-table-column>
      <el-table-column prop="answer_B2" label="语音通话清晰度" width="65">
        <template slot-scope="scope">
          <div :style="{backgroundColor: color(scope.row.sn_answer_B2),fontWeight: scope.row.city_name === '全省'?'bold':'normal'}">{{ scope.row.answer_B2 }}</div>
        </template>
      </el-table-column>
      <el-table-column prop="answer_B4" label="语音通话稳定性" width="65">
        <template slot-scope="scope">
          <div :style="{backgroundColor: color(scope.row.sn_answer_B4),fontWeight: scope.row.city_name === '全省'?'bold':'normal'}">{{ scope.row.answer_B4 }}</div>
        </template>
      </el-table-column>
    </el-table-column>
